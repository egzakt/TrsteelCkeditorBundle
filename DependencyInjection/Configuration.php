...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->end()
            ->children()
                ->scalarNode('fontsize_sizes')
                    ->defaultNull()
                    ->info("The list of fonts size to be displayed in the Font Size combo in the toolbar. Entries are separated by semi-colons (';').")
                    ->example('12 Pixels/12px;Big/2.3em;30 Percent More/130%;Bigger/larger;Very Small/x-small')
                ->end()
            ->end()
            ->children()
                ->scalarNode('styles_set')
                    ->defaultNull()
                    ->info("The \"styles definition set\" to use in the editor. They will be used in the styles combo and the style selector of the div container.")
                    ->example("mystyles:/editorstyles/styles.js")
                ->end()
            ->end()
            ->children()
                ->scalarNode('templates')
                    ->defaultNull()
                    ->info("The templates definition set to use. It accepts a list of names separated by comma. It must match definitions loaded with the templates_files setting.")
                    ->example('my_templates')
                ->end()
            ->end()
            ->children()
                ->arrayNode('templates_files')
                    ->beforeNormalization()
                    ->ifString()
                        ->then(function($v) { return array($v); })
                    ->end()
            ...
            ->end()
            ->children()
                ->arrayNode('templates_definition_sets')
                    ->useAttributeAsKey('name')
                    ->prototype('array')
                        ->children()
                            ->scalarNode('imagesPath')->defaultNull()->end()
                            ->arrayNode('templates')
                                ->prototype('array')
                                    ->children()
                                        ...
                                        ->scalarNode('twig')->defaultNull()->end()
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
